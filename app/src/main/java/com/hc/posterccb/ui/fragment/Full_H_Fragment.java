...
public class Full_H_Fragment extends BaseHiddenFragment implements
...
//                            Log.e("现在时间", currentTime + "---");
            ...
            try {
                ...
                Log.e("是否", b + "");
                if (isInTime && !mApplication.isAreaIsPlay() && mApplication.getDisplayModel().equals("model_full_h")) {
