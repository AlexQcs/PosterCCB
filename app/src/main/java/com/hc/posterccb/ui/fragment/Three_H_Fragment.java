...
public class Three_H_Fragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_three__h_, container, false);
...
//                            Log.e("现在时间", currentTime + "---");
            ...
            try {
                //定时播放
                if (isInTime && !mApplication.isAreaIsPlay() && mApplication.getDisplayModel().equals("model_three_h")) {
