...
import com.hc.posterccb.ui.presenter.Second_H_FrgmPresenter;
...
public class Second_H_Fragment extends BaseFragment<Second_H_FrgmPresenter> implements
        Second_H_Constract.FrgmView {
...
//                            Log.e("现在时间", currentTime + "---");
    ...
    @Override
    protected Second_H_FrgmPresenter loadPresenter() {
        return new Second_H_FrgmPresenter();
    }
